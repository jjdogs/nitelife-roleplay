if Config.Banking ~= 'Renewed-Banking' then return end
...
function RemoveMoneyFromSociety(society, price, playerIdentifier)
    ...
    local money = exports['Renewed-Banking']:getAccountMoney(society)
    if money < price then return false end

    local removed = exports['Renewed-Banking']:removeAccountMoney(society, price)
    return removed
end