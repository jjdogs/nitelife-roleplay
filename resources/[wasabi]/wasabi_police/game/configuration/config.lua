...
Config.Locations = {
    LSPD = {
        blip = {
            enabled = true,
            coords = vec3(-292.80, -1054.64, 28.34),
            sprite = 60,
            color = 29,
            scale = 1.0,
            string = 'Alta Street PD'
        },
        ...
        bossMenu = {
            enabled = true,
            jobLock = 'police',
            coords = vec3(-304.23, -1045.30, 31.26),
        ...
        armoury = {
            enabled = false,                             -- Disabled: using lation_shops for armory
        ...
        cloakroom = {
            enabled = false,
            jobLock = 'police',
            coords = vec3(-312.36, -1060.68, 28.34),
        ...
        vehicles = {                                   -- Vehicle Garage
            enabled = false,                           -- Disabled: using jg-advancedgarages
            jobLock = 'police',                        -- Job lock? or access to all police jobs by using false
            zone = {
