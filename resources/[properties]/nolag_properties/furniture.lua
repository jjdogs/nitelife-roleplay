...
FurnitureConfig.Furniture = {
	...
	electronics = {
		...
		items = {
			...
			{ object = 'prop_cs_cctv',                      price = 130,  label = 'CCTV', type = "camera", lens = vector3(-0.00, -0.21, -0.18), pointAt = vector3(-0.01, -1.49, -0.66)},
			{ object = 'prop_cctv_cam_01b',                 price = 120,  label = 'CCTV Cam 01b', type = "camera", lens = vector3(-0.15, -0.62, 0.21), pointAt = vector3(-1.10, -2.42, -0.83)},
			{ object = 'prop_cctv_cam_02a',                 price = 135,  label = 'CCTV Cam 02a', type = "camera", lens = vector3(0.13, -0.24, -0.09), pointAt = vector3(0.64, -1.17, -0.76)},
			{ object = 'prop_cctv_cam_03a',                 price = 155,  label = 'CCTV Cam 03a', type = "camera", lens = vector3(-0.45, -0.48, 0.29), pointAt = vector3(-2.25, -2.17, -0.72)},
			{ object = 'prop_cctv_cam_04a',                 price = 250,  label = 'CCTV Cam 04a', type = "camera", lens = vector3(-0.00, -0.78, 0.64), pointAt = vector3(0.18, -2.88, -0.21)},
			{ object = 'prop_cctv_cam_04b',                 price = 250,  label = 'CCTV Cam 04b', type = "camera", lens = vector3(-0.00, -0.66, 0.51), pointAt = vector3(-0.12, -2.23, -0.55)},
			{ object = 'prop_cctv_cam_04c',                 price = 250,  label = 'CCTV Cam 04c', type = "camera", lens = vector3(-0.01, -0.30, -0.33), pointAt = vector3(-0.01, -1.98, -2.13)},
			{ object = 'prop_cctv_cam_05a',                 price = 120,  label = 'CCTV Cam 05a', type = "camera", lens = vector3(-0.01, -0.30, -0.48), pointAt = vector3(-0.01, -1.85, -1.23)},
			{ object = 'prop_cctv_cam_06a',                 price = 120,  label = 'CCTV Cam 06a', type = "camera", lens = vector3(0.01, -0.19, -0.34), pointAt = vector3(0.01, -1.55, -0.80)},
			{ object = 'prop_cctv_cam_07a',                 price = 160,  label = 'CCTV Cam 07a', type = "camera", lens = vector3(0.01, -0.00, -0.15), pointAt = vector3(-0.15, -0.93, -1.13)},
			{ object = 'prop_cctv_pole_01a',                price = 230,  label = 'CCTV Pole 01a', type = "camera", lens = vector3(-0.36, -0.17, 7.21), pointAt = vector3(-4.37, -1.86, 5.64)},
			{ object = 'prop_cctv_pole_02',                 price = 480,  label = 'CCTV Pole 02', type = "camera", lens = vector3(-0.00, -0.21, -0.18), pointAt = vector3(-0.01, -1.49, -0.66)},
			{ object = 'prop_cctv_pole_03',                 price = 500,  label = 'CCTV Pole 03', type = "camera", lens = vector3(-0.00, -0.21, -0.18), pointAt = vector3(-0.01, -1.49, -0.66)},
			{ object = 'prop_cctv_pole_04',                 price = 450,  label = 'CCTV Pole 04', type = "camera", lens = vector3(-0.00, -0.21, -0.18), pointAt = vector3(-0.01, -1.49, -0.66)},
	...
	lightning = {
		...
		icon = '💡',
		items = {
			{ object = 'nolag_lightswitch_01',           price = 175,  label = 'Light Switch' },
			{ object = 'nolag_lightswitch_02',           price = 175,  label = 'Light Switch' },
			{ object = 'nolag_lightswitch_03',           price = 175,  label = 'Light Switch' },
			{ object = 'reh_prop_reh_switch_01a',           price = 175,  label = 'Light Switch' },
