Config = {
    ...
    MaxSecurityCameras = 5,
    MaxSecurityCamerasInside = 0,
    MaxSecurityCamerasOutside = 0,
    UtilityBills = {
        Enabled = true,
        BillingPeriod = 3,
        GratisPeriod = 1,
    ...
    StarterApartment = {
        ...
        BuildingId = 7,
        Address = "Strawberry Ave 1",
        Name = "Legion Square Apartments",
        UniqueName = true,
        RentedInstead = true,
        InitialRentDays = 7,
        FutureRentPrice = 250,
    ...
    RequireBossGradeForSocietyBuying = true,
