...
Settings.props = {
    ...
    {
        category = 'DNX Buildings',
        items = {
            {model = 'dnxprops_buildings_bulletinboard01_a'},
            {model = 'dnxprops_buildings_bulletinboard01_empty'},
            {model = 'dnxprops_buildings_canopysmall01_a'},
            {model = 'dnxprops_buildings_canopysmall02_a'},
            {model = 'dnxprops_buildings_canopysmall03_a'},
            {model = 'dnxprops_buildings_canopysmall04_a'},
            {model = 'dnxprops_buildings_canopysmall05_a'},
            {model = 'dnxprops_buildings_canopysmall06_a'},
            {model = 'dnxprops_buildings_gasboiler01'},
            {model = 'dnxprops_buildings_gasboiler02'},
            {model = 'dnxprops_buildings_gasboiler03'},
            {model = 'dnxprops_buildings_gasboiler04'},
            {model = 'dnxprops_buildings_privacyscreen01_a'},
            {model = 'dnxprops_buildings_privacyscreen01_a_hedge'},
            {model = 'dnxprops_buildings_watertank01'},
        }
    },
    {
        category = 'DNX Effects',
        items = {
            {model = 'dnxprops_effects_fire_campfire'},
            {model = 'dnxprops_effects_fire_fireplace'},
            {model = 'dnxprops_effects_smoke_acvent'},
            {model = 'dnxprops_effects_smoke_factory'},
            {model = 'dnxprops_effects_smoke_roofvent'},
            {model = 'dnxprops_effects_water_drips_med'},
            {model = 'dnxprops_effects_water_drips_small'},
            {model = 'dnxprops_effects_water_drips_tap'},
            {model = 'dnxprops_effects_water_fountain_single'},
            {model = 'dnxprops_effects_water_pour_short_rain'},
        }
    },
    {
        category = 'DNX Electronics',
        items = {
            {model = 'dnxprops_electronics_arrowbutton01_a'},
            {model = 'dnxprops_electronics_arrowbutton01_b'},
            {model = 'dnxprops_electronics_doorbell01_a'},
            {model = 'dnxprops_electronics_doorbell01_a_custom01'},
            {model = 'dnxprops_electronics_doorbell01_a_custom02'},
            {model = 'dnxprops_electronics_doorbell01_a_custom03'},
            {model = 'dnxprops_electronics_doorbell01_a_custom04'},
            {model = 'dnxprops_electronics_doorbell01_a_custom05'},
            {model = 'dnxprops_electronics_doorbell01_b'},
            {model = 'dnxprops_electronics_doorbell01_b_custom01'},
            {model = 'dnxprops_electronics_doorbell01_b_custom02'},
            {model = 'dnxprops_electronics_doorbell01_b_custom03'},
            {model = 'dnxprops_electronics_doorbell01_b_custom04'},
            {model = 'dnxprops_electronics_doorbell01_b_custom05'},
            {model = 'dnxprops_electronics_intercom01_a'},
            {model = 'dnxprops_electronics_lightbutton01_a'},
            {model = 'dnxprops_electronics_lightbutton01_b'},
            {model = 'dnxprops_electronics_socketswitchus01_combo1_a'},
            {model = 'dnxprops_electronics_socketswitchus01_combo1_b'},
            {model = 'dnxprops_electronics_socketus01_double_a'},
            {model = 'dnxprops_electronics_socketus01_double_b'},
            {model = 'dnxprops_electronics_socketus01_single_a'},
            {model = 'dnxprops_electronics_socketus01_single_b'},
            {model = 'dnxprops_electronics_switch01_double_a'},
            {model = 'dnxprops_electronics_switch01_double_b'},
            {model = 'dnxprops_electronics_switch01_single_a'},
            {model = 'dnxprops_electronics_switch01_single_b'},
            {model = 'dnxprops_electronics_switch01_triple_a'},
            {model = 'dnxprops_electronics_switch01_triple_b'},
            {model = 'dnxprops_electronics_tvantenna01'},
        }
    },
    {
        category = 'DNX Entertainment',
        items = {
            {model = 'dnxprops_entertainment_manga01_a'},
            {model = 'dnxprops_entertainment_manga01_b'},
            {model = 'dnxprops_entertainment_manga01_c'},
            {model = 'dnxprops_entertainment_manga01_d'},
            {model = 'dnxprops_entertainment_manga01_e'},
        }
    },
    {
        category = 'DNX Fire Safety',
        items = {
            {model = 'dnxprops_fire_extinguisher1'},
            {model = 'dnxprops_fire_extinguisher2'},
            {model = 'dnxprops_fire_extinguisherbracket01_a'},
            {model = 'dnxprops_fire_extinguisherbracket01_b'},
        }
    },
    {
        category = 'DNX Furniture - Bathroom',
        items = {
            {model = 'dnxprops_furniture_bathroomcabinet01_a'},
            {model = 'dnxprops_furniture_bathroomcabinet01_b'},
            {model = 'dnxprops_furniture_bathroomcabinet01_c'},
            {model = 'dnxprops_furniture_bathroomsink01_a'},
            {model = 'dnxprops_furniture_bathtub02_a'},
            {model = 'dnxprops_furniture_bidet'},
            {model = 'dnxprops_furniture_shower01_a'},
            {model = 'dnxprops_furniture_shower02_a'},
            {model = 'dnxprops_furniture_shower03_a'},
            {model = 'dnxprops_furniture_toilet01_a'},
            {model = 'dnxprops_furniture_toilet01_b'},
            {model = 'dnxprops_furniture_toilet01_c'},
        }
    },
    {
        category = 'DNX Furniture - Bedroom',
        items = {
            {model = 'dnxprops_furniture_wardrobedrawer01_a'},
            {model = 'dnxprops_furniture_wardrobedrawer01_b'},
            {model = 'dnxprops_furniture_wardrobedrawer01_c'},
            {model = 'dnxprops_furniture_wardrobelarge01_a'},
            {model = 'dnxprops_furniture_wardrobelarge01_b'},
            {model = 'dnxprops_furniture_wardrobelarge01_c'},
            {model = 'dnxprops_furniture_wardrobesmall01_a'},
            {model = 'dnxprops_furniture_wardrobesmall01_b'},
            {model = 'dnxprops_furniture_wardrobesmall01_c'},
        }
    },
    {
        category = 'DNX Furniture - Bookshelves',
        items = {
            {model = 'dnxprops_furniture_bookshelf01_a'},
            {model = 'dnxprops_furniture_bookshelf01_b'},
            {model = 'dnxprops_furniture_bookshelf01_books'},
            {model = 'dnxprops_furniture_bookshelf01_c'},
            {model = 'dnxprops_furniture_bookshelflarge01_a'},
            {model = 'dnxprops_furniture_bookshelflarge01_b'},
            {model = 'dnxprops_furniture_bookshelflarge01_c'},
        }
    },
    {
        category = 'DNX Furniture - Coat Racks',
        items = {
            {model = 'dnxprops_furniture_coatrack01_a'},
            {model = 'dnxprops_furniture_coatrack01_b'},
            {model = 'dnxprops_furniture_coatrack01_c'},
        }
    },
    {
        category = 'DNX Furniture - Desks',
        items = {
            {model = 'dnxprops_furniture_desk01_a'},  {model = 'dnxprops_furniture_desk01_b'},  {model = 'dnxprops_furniture_desk01_c'},
            {model = 'dnxprops_furniture_desk02_a'},  {model = 'dnxprops_furniture_desk02_b'},  {model = 'dnxprops_furniture_desk02_c'},
            {model = 'dnxprops_furniture_desk03_a'},  {model = 'dnxprops_furniture_desk03_b'},  {model = 'dnxprops_furniture_desk03_c'},
            {model = 'dnxprops_furniture_desk04_a'},  {model = 'dnxprops_furniture_desk04_b'},  {model = 'dnxprops_furniture_desk04_c'},
            {model = 'dnxprops_furniture_desk05_a'},  {model = 'dnxprops_furniture_desk05_b'},  {model = 'dnxprops_furniture_desk05_c'},
            {model = 'dnxprops_furniture_desk06_a'},  {model = 'dnxprops_furniture_desk06_b'},  {model = 'dnxprops_furniture_desk06_c'},
            {model = 'dnxprops_furniture_desk07_a'},  {model = 'dnxprops_furniture_desk07_b'},  {model = 'dnxprops_furniture_desk07_c'},
            {model = 'dnxprops_furniture_desk08_a'},  {model = 'dnxprops_furniture_desk08_b'},  {model = 'dnxprops_furniture_desk08_c'},
            {model = 'dnxprops_furniture_desk09_a'},  {model = 'dnxprops_furniture_desk09_b'},  {model = 'dnxprops_furniture_desk09_c'},
            {model = 'dnxprops_furniture_desk10_a'},  {model = 'dnxprops_furniture_desk10_b'},  {model = 'dnxprops_furniture_desk10_c'},
            {model = 'dnxprops_furniture_desk11_a'},  {model = 'dnxprops_furniture_desk11_b'},  {model = 'dnxprops_furniture_desk11_c'},
            {model = 'dnxprops_furniture_desk12_a'},  {model = 'dnxprops_furniture_desk12_b'},  {model = 'dnxprops_furniture_desk12_c'},
            {model = 'dnxprops_furniture_desk13_a'},  {model = 'dnxprops_furniture_desk13_b'},  {model = 'dnxprops_furniture_desk13_c'},
            {model = 'dnxprops_furniture_deskwood01_a'}, {model = 'dnxprops_furniture_deskwood01_b'}, {model = 'dnxprops_furniture_deskwood01_c'},
        }
    },
    {
        category = 'DNX Furniture - Dining',
        items = {
            {model = 'dnxprops_furniture_dinningtable01_a'},
            {model = 'dnxprops_furniture_dinningtable01_b'},
            {model = 'dnxprops_furniture_dinningtable02_a'},
            {model = 'dnxprops_furniture_dinningtable02_b'},
        }
    },
    {
        category = 'DNX Furniture - Filing',
        items = {
            {model = 'dnxprops_furniture_filecabinetlarge01_a'},
            {model = 'dnxprops_furniture_filecabinetlarge01_b'},
            {model = 'dnxprops_furniture_filecabinetlarge01_c'},
        }
    },
    {
        category = 'DNX Furniture - Kitchen',
        items = {
            {model = 'dnxprops_furniture_kitchencabinet01_a'}, {model = 'dnxprops_furniture_kitchencabinet01_b'},
            {model = 'dnxprops_furniture_kitchencabinet02_a'}, {model = 'dnxprops_furniture_kitchencabinet02_b'},
            {model = 'dnxprops_furniture_kitchencabinet03_a'}, {model = 'dnxprops_furniture_kitchencabinet03_b'},
            {model = 'dnxprops_furniture_kitchencabinet04_a'}, {model = 'dnxprops_furniture_kitchencabinet04_b'},
            {model = 'dnxprops_furniture_kitchencabinet05_a'}, {model = 'dnxprops_furniture_kitchencabinet05_b'},
            {model = 'dnxprops_furniture_kitchencabinet06_a'}, {model = 'dnxprops_furniture_kitchencabinet06_b'},
            {model = 'dnxprops_furniture_kitchencabinet07_a'}, {model = 'dnxprops_furniture_kitchencabinet07_b'},
            {model = 'dnxprops_furniture_kitchencabinet08_a'}, {model = 'dnxprops_furniture_kitchencabinet08_b'},
            {model = 'dnxprops_furniture_kitchencabinet09_a'}, {model = 'dnxprops_furniture_kitchencabinet09_b'},
            {model = 'dnxprops_furniture_kitchencabinet10_a'}, {model = 'dnxprops_furniture_kitchencabinet10_b'},
            {model = 'dnxprops_furniture_kitchencabinet11_a'}, {model = 'dnxprops_furniture_kitchencabinet11_b'},
            {model = 'dnxprops_furniture_kitchencabinet12_a'}, {model = 'dnxprops_furniture_kitchencabinet12_b'},
            {model = 'dnxprops_furniture_kitchencabinet13_a'}, {model = 'dnxprops_furniture_kitchencabinet13_b'},
            {model = 'dnxprops_furniture_kitchendishwasher_a'},
            {model = 'dnxprops_furniture_kitchendishwasher_b'},
            {model = 'dnxprops_furniture_kitchenfridgelarge01_a'},
            {model = 'dnxprops_furniture_kitchenoven01_a'}, {model = 'dnxprops_furniture_kitchenoven01_b'},
            {model = 'dnxprops_furniture_kitchenoven02_a'}, {model = 'dnxprops_furniture_kitchenoven02_b'},
        }
    },
    {
        category = 'DNX Furniture - Shelves',
        items = {
            {model = 'dnxprops_furniture_shelf01_a'},
            {model = 'dnxprops_furniture_shelf01_b'},
        }
    },
    {
        category = 'DNX Home Accessories',
        items = {
            {model = 'dnxprops_home_aftershave01_a'},
            {model = 'dnxprops_home_barberbrush01_a'},
            {model = 'dnxprops_home_bathroomorganizer01_a_empty'},
            {model = 'dnxprops_home_ceramicbowl01_a'},
            {model = 'dnxprops_home_ceramicbowl01_b'},
            {model = 'dnxprops_home_ceramicbowl01_c'},
            {model = 'dnxprops_home_contactlensescase'},
            {model = 'dnxprops_home_deskorganizer01_a'},
            {model = 'dnxprops_home_deskorganizer01_b'},
            {model = 'dnxprops_home_deskorganizer01_c'},
            {model = 'dnxprops_home_deskorganizer02_a'},
            {model = 'dnxprops_home_deskorganizer02_b'},
            {model = 'dnxprops_home_deskorganizer02_c'},
            {model = 'dnxprops_home_diecastrhino'},
            {model = 'dnxprops_home_digitalbathroomscale01_a'},
            {model = 'dnxprops_home_digitalbathroomscale01_b'},
            {model = 'dnxprops_home_jarcoffee01_a'},
            {model = 'dnxprops_home_jarcoffee01_b'},
            {model = 'dnxprops_home_jarsalt01_a'},
            {model = 'dnxprops_home_jarsalt01_b'},
            {model = 'dnxprops_home_jarsugar01_a'},
            {model = 'dnxprops_home_jarsugar01_b'},
            {model = 'dnxprops_home_lantern01_a_empty'},
            {model = 'dnxprops_home_lantern02_a_empty'},
            {model = 'dnxprops_home_liquidsoap01_a'},
            {model = 'dnxprops_home_mirror01_a'}, {model = 'dnxprops_home_mirror01_b'}, {model = 'dnxprops_home_mirror01_c'},
            {model = 'dnxprops_home_mirror02_a'}, {model = 'dnxprops_home_mirror02_b'}, {model = 'dnxprops_home_mirror02_c'},
            {model = 'dnxprops_home_mirror03_a'}, {model = 'dnxprops_home_mirror03_b'}, {model = 'dnxprops_home_mirror03_c'},
            {model = 'dnxprops_home_mirror04_a'}, {model = 'dnxprops_home_mirror04_b'}, {model = 'dnxprops_home_mirror04_c'},
            {model = 'dnxprops_home_mouthwash01_a'},
            {model = 'dnxprops_home_picture01'}, {model = 'dnxprops_home_picture02'}, {model = 'dnxprops_home_picture03'},
            {model = 'dnxprops_home_picture04'}, {model = 'dnxprops_home_picture05'}, {model = 'dnxprops_home_picture06'},
            {model = 'dnxprops_home_strawcup'},
            {model = 'dnxprops_home_toiletbrush01_a'},
            {model = 'dnxprops_home_toiletbrush02_a'},
            {model = 'dnxprops_home_towelrail01_a'}, {model = 'dnxprops_home_towelrail01_b'}, {model = 'dnxprops_home_towelrail01_c'},
            {model = 'dnxprops_home_umbrellastand01'},
        }
    },
    {
        category = 'DNX Lighting',
        items = {
            {model = 'dnxprops_lighting_ceilinglight01_a'},
            {model = 'dnxprops_lighting_ceilinglight01_a_24h'},
            {model = 'dnxprops_lighting_ceilinglight02_a'},
            {model = 'dnxprops_lighting_picketlight01_a'},
            {model = 'dnxprops_lighting_picketlight02_a'},
        }
    },
    {
        category = 'DNX Music',
        items = {
            {model = 'dnxprops_music_guitarwallmount01_a'},
            {model = 'dnxprops_music_guitarwallmount01_b'},
            {model = 'dnxprops_music_keyboard01_a_88'},
            {model = 'dnxprops_music_keyboardstand01_a'},
        }
    },
    {
        category = 'DNX Tech / Gaming',
        items = {
            {model = 'dnxprops_tech_gamingchair01_black'},   {model = 'dnxprops_tech_gamingchair01_blue'},
            {model = 'dnxprops_tech_gamingchair01_green'},   {model = 'dnxprops_tech_gamingchair01_pink'},
            {model = 'dnxprops_tech_gamingchair01_purple'},  {model = 'dnxprops_tech_gamingchair01_red'},
            {model = 'dnxprops_tech_gamingchair01_white'},   {model = 'dnxprops_tech_gamingchair01_yellow'},
            {model = 'dnxprops_tech_gamingkeyboard01_a_blue'},   {model = 'dnxprops_tech_gamingkeyboard01_a_cyan'},
            {model = 'dnxprops_tech_gamingkeyboard01_a_green'},  {model = 'dnxprops_tech_gamingkeyboard01_a_off'},
            {model = 'dnxprops_tech_gamingkeyboard01_a_purple'}, {model = 'dnxprops_tech_gamingkeyboard01_a_red'},
            {model = 'dnxprops_tech_gamingkeyboard01_a_rgb1'},   {model = 'dnxprops_tech_gamingkeyboard01_a_rgb2'},
            {model = 'dnxprops_tech_gamingkeyboard01_a_yellow'},
            {model = 'dnxprops_tech_gamingkeyboard01_b_blue'},   {model = 'dnxprops_tech_gamingkeyboard01_b_cyan'},
            {model = 'dnxprops_tech_gamingkeyboard01_b_green'},  {model = 'dnxprops_tech_gamingkeyboard01_b_off'},
            {model = 'dnxprops_tech_gamingkeyboard01_b_purple'}, {model = 'dnxprops_tech_gamingkeyboard01_b_red'},
            {model = 'dnxprops_tech_gamingkeyboard01_b_rgb1'},   {model = 'dnxprops_tech_gamingkeyboard01_b_rgb2'},
            {model = 'dnxprops_tech_gamingkeyboard01_b_yellow'},
            {model = 'dnxprops_tech_gamingmonitor01_a_27_off'},      {model = 'dnxprops_tech_gamingmonitor01_a_27_wp1'},
            {model = 'dnxprops_tech_gamingmonitor01_a_27_wp2'},      {model = 'dnxprops_tech_gamingmonitor01_a_27_wpcustom1'},
            {model = 'dnxprops_tech_gamingmonitor01_a_27_wpcustom2'},{model = 'dnxprops_tech_gamingmonitor01_a_27_wpcustom3'},
            {model = 'dnxprops_tech_gamingmonitor01_a_27_wpcustom4'},{model = 'dnxprops_tech_gamingmonitor01_a_27_wpcustom5'},
            {model = 'dnxprops_tech_gamingmonitor01_b_27_off'},      {model = 'dnxprops_tech_gamingmonitor01_b_27_wp1'},
            {model = 'dnxprops_tech_gamingmonitor01_b_27_wp2'},      {model = 'dnxprops_tech_gamingmonitor01_b_27_wpcustom1'},
            {model = 'dnxprops_tech_gamingmonitor01_b_27_wpcustom2'},{model = 'dnxprops_tech_gamingmonitor01_b_27_wpcustom3'},
            {model = 'dnxprops_tech_gamingmonitor01_b_27_wpcustom4'},{model = 'dnxprops_tech_gamingmonitor01_b_27_wpcustom5'},
            {model = 'dnxprops_tech_gamingmouse01_a_blue'},   {model = 'dnxprops_tech_gamingmouse01_a_cyan'},
            {model = 'dnxprops_tech_gamingmouse01_a_green'},  {model = 'dnxprops_tech_gamingmouse01_a_off'},
            {model = 'dnxprops_tech_gamingmouse01_a_purple'}, {model = 'dnxprops_tech_gamingmouse01_a_red'},
            {model = 'dnxprops_tech_gamingmouse01_a_rgb1'},   {model = 'dnxprops_tech_gamingmouse01_a_rgb2'},
            {model = 'dnxprops_tech_gamingmouse01_a_yellow'},
            {model = 'dnxprops_tech_gamingmouse01_b_blue'},   {model = 'dnxprops_tech_gamingmouse01_b_cyan'},
            {model = 'dnxprops_tech_gamingmouse01_b_green'},  {model = 'dnxprops_tech_gamingmouse01_b_off'},
            {model = 'dnxprops_tech_gamingmouse01_b_purple'}, {model = 'dnxprops_tech_gamingmouse01_b_red'},
            {model = 'dnxprops_tech_gamingmouse01_b_rgb1'},   {model = 'dnxprops_tech_gamingmouse01_b_rgb2'},
            {model = 'dnxprops_tech_gamingmouse01_b_yellow'},
            {model = 'dnxprops_tech_gamingmousepad01_a_blue'},   {model = 'dnxprops_tech_gamingmousepad01_a_cyan'},
            {model = 'dnxprops_tech_gamingmousepad01_a_green'},  {model = 'dnxprops_tech_gamingmousepad01_a_off'},
            {model = 'dnxprops_tech_gamingmousepad01_a_purple'}, {model = 'dnxprops_tech_gamingmousepad01_a_red'},
            {model = 'dnxprops_tech_gamingmousepad01_a_rgb1'},   {model = 'dnxprops_tech_gamingmousepad01_a_rgb2'},
            {model = 'dnxprops_tech_gamingmousepad01_a_yellow'},
            {model = 'dnxprops_tech_gamingpc01_a_blue'},   {model = 'dnxprops_tech_gamingpc01_a_cyan'},
            {model = 'dnxprops_tech_gamingpc01_a_green'},  {model = 'dnxprops_tech_gamingpc01_a_off'},
            {model = 'dnxprops_tech_gamingpc01_a_purple'}, {model = 'dnxprops_tech_gamingpc01_a_red'},
            {model = 'dnxprops_tech_gamingpc01_a_rgb1'},   {model = 'dnxprops_tech_gamingpc01_a_rgb2'},
            {model = 'dnxprops_tech_gamingpc01_a_yellow'},
            {model = 'dnxprops_tech_gamingpc01_b_blue'},   {model = 'dnxprops_tech_gamingpc01_b_cyan'},
            {model = 'dnxprops_tech_gamingpc01_b_green'},  {model = 'dnxprops_tech_gamingpc01_b_off'},
            {model = 'dnxprops_tech_gamingpc01_b_purple'}, {model = 'dnxprops_tech_gamingpc01_b_red'},
            {model = 'dnxprops_tech_gamingpc01_b_rgb1'},   {model = 'dnxprops_tech_gamingpc01_b_rgb2'},
            {model = 'dnxprops_tech_gamingpc01_b_yellow'},
            {model = 'dnxprops_tech_gamingpccase01_a'},     {model = 'dnxprops_tech_gamingpccase01_b'},
            {model = 'dnxprops_tech_gamingpcfan01_a'},      {model = 'dnxprops_tech_gamingpcfan01_b'},
            {model = 'dnxprops_tech_gamingpcgpu01_a'},      {model = 'dnxprops_tech_gamingpcgpu01_b'},
            {model = 'dnxprops_tech_gamingpcmotherboard01_a'},
            {model = 'dnxprops_tech_gamingpcram01_a'},      {model = 'dnxprops_tech_gamingpcram01_b'},
            {model = 'dnxprops_tech_gamingpcssd01_a'},      {model = 'dnxprops_tech_gamingpcssd01_b'},
            {model = 'dnxprops_tech_gamingpcssd01_c'},      {model = 'dnxprops_tech_gamingpcssd01_d'},
            {model = 'dnxprops_tech_pcspeaker01_a'},
            {model = 'dnxprops_tech_pcsubwoofer01_a'},
        }
    },
    {
        category = 'Clutter',
